...
import { suggestMVPPlanPrompt_es } from '@/lib/prompts';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const model = payloadSize > 5000 ? 'quality' : 'fast';

    const prompt = suggestMVPPlanPrompt_es(payload);
    ...
    console.error('suggestMVPPlan error:', error);
